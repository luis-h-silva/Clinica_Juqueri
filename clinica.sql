...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 09/12/2025 às 20:14
...
(2, 1, 1, '2025-12-18', '14:00:00', 'CANCELADA'),
(3, 1, 1, '2025-12-25', '14:00:00', 'CANCELADA'),
(4, 1, 1, '2025-12-25', '10:00:00', 'ATIVA'),
(5, 1, 1, '2025-12-24', '16:00:00', 'ATIVA'),
(6, 1, 2, '2026-01-09', '14:00:00', 'ATIVA');
...
INSERT INTO `pacientes` (`id`, `nome`, `email`, `senha`, `notificacao`) VALUES
(1, 'João Pedro Martins Lourenço', 'diasdeluta@gmail.com', 'abcd123456', NULL);
...
('root', '[{\"db\":\"clinica\",\"table\":\"admin\"},{\"db\":\"clinica\",\"table\":\"medicos\"},{\"db\":\"clinica\",\"table\":\"consultas\"},{\"db\":\"clinica\",\"table\":\"pacientes\"},{\"db\":\"clinica\",\"table\":\"especialidades\"},{\"db\":\"clinica\",\"table\":\"paciente\"}]');
...
('root', '2025-12-09 16:27:04', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
